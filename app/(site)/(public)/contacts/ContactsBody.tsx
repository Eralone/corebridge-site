 ...
 * Что осталось: почта, телефон и три поля для идентификации Исполнителя —
      ...
      <section className="contact-grid">
        <div>
          <div className="contact-cards">
            ...
            <div className="c-card">
              <div className="ic" style={{ background: 'rgba(31,157,85,.12)', color: 'var(--success)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-17.7-17.7A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.7a2 2 0 0 1-.5 2.1L8 9.6a16 16 0 0 0 6.4 6.4l1.1-1.1a2 2 0 0 1 2.1-.5c.9.3 1.8.5 2.7.6a2 2 0 0 1 1.7 2z" />
                </svg>
              </div>
              <h4>Телефон</h4>
              <div className="val">
                {/* номер из оферты §11; в эталоне был московский +7 (495) 181-12-34 */}
                <a href="tel:+79809556341">+7 980 955‑63‑41</a>
              </div>
              {/* ⚠️ «9:00–21:00 МСК» из эталона не переносим: часы не подтверждены */}
              <div className="hint">По рабочим дням</div>
            </div>
          </div>

          <p className="text-muted" style={{ fontSize: 13, marginTop: 20 }}>
            Работаем удалённо, приёмного офиса нет — все вопросы решаем письмом или звонком.
