...
const SEGMENTS: {
  ...
  },
  {
    ...
    /**
     * ⚠️ В эталоне здесь стоял путь `M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5`
     * — он рисует надкусанный круг («печенье») и рядом со словом «Производство»
     * читается как сломанная картинка. Заменено на завод: корпус, две трубы, окна.
     */
    icon: (
      <>
  ...
  },
  {
    ...
    /**
     * ⚠️ В эталоне — круг, перечёркнутый крестом. Рядом с «партнёрами» читается
     * как знак запрета. Заменено на схему связей: узел в центре и три ветки —
     * то, чем интегратор и занимается.
     */
    icon: (
      <>
        ...
        <path d="M6.5 6.5 10 10M17.5 6.5 14 10M12 14.5V19" />
      </>
    ),
