    ...
    <>
      ...
      <div className="docs-layout">
        ...
        <main className="docs-content">
          ...
          {/* Ссылка в раздел разборов: инструкции отвечают «как настроить»,
              разборы — «почему не сходится». Без неё у нового раздела не было бы
              ни одной входящей ссылки с проиндексированных страниц */}
          <p>
            Настройка описана здесь по шагам. Если обмен уже настроен, но данные
            расходятся, смотрите <Link href="/razbory">разборы механик</Link>: почему
            не сходятся остатки, куда попадает оплата по СБП, где теряется отгрузка.
          </p>
