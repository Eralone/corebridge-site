 ...
 * `admin-users.html`.
 *
 * Сводка по очередям (`GET /admin/queues/stats`) сейчас отвечает 500: запрос
 * фильтрует DLQ по колонке `status`, которой нет ни в одной из двух таблиц
 * `dead_letter_queue` (промт S13 §4). Сам список DLQ работает, поэтому экран
 * показывает его и честно говорит, чего не хватает.
 */
